...
/**
 ...
 Si N es la raíz de A, y tiene un solo hijo, este pasa a ser la nueva raíz del árbol.
...
/**
 ...
 El nuevo árbol en *SA se compone de los nodos del sub�rbol de A a partir de N.
